      ...
      <section className="profile__about section-padding">
        <article className="container">
          <div className="profile__aboutContent">
            ...
            <p>I am open to discuss any services listed on this portfolio site and beyond. Feel free to reach out for consultation, pitch a project or to talk sneaker releases and camera gear with me.</p>
          </div>
