...
const Jamestown = () => (
  <Layout title="Jamestown" pageClass="jamestown" landing>
    <section className="profile__about section-padding">
      <article className="container">
        <div className="profile__aboutContent">
          ...
          <p>
            I am a frontend developer with over 11 years of industry experience building websites, HTML emails and web
            applications, providing strategy while building and launching high quality, engaging products. I have
            professional experience working with JavaScript and PHP. Other frameworks and technologies I've worked
            include NodeJS, React, VueJS, Gatsby, NextJS, Salesforce Storefront Reference Architecture (SFRA) and
            various headless CMSs.
          </p>
        ...
        <div className="profile__proposal">
          <h2 className="el-h2">Proposal</h2>
          <h2 className="el-h1">HTML Email Development</h2>
          <p>
            Development of HTML emails includes a responsive HTML email. One key goal is to ensure that the email works
            in the most prominently used email clients and devices of your clients/customers. Insight into your email
            analytics should help identify those email clients.
          </p>
        </div>
        <div className="profile__proposal">
          <h2 className="el-h1">Rates</h2>
          <p>
            For all services provided, my hourly rate is <strong>$125/hour</strong>.
          </p>
          <p>
            Basic HTML emails should take 6-10 hours to develop, depending on the amount of content, complexity of the
            design, the email client stack of your customers/clients and functionality required.
          </p>
        </div>
      </article>
    </section>
