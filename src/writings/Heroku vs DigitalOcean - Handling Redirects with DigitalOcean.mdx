---
path: "/heroku-vs-digitalocean/handling-redirects-with-digitalocean"
date: "2018-03-01"
...
<div className="blog__toc">
  ...
  <ul>
    ...
    <li><Link class="current" to="/writings/heroku-vs-digitalocean/handling-redirects-with-digitalocean">Part 3: Handling Redirects with DigialOcean</Link></li>
